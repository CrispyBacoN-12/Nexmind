import "dotenv/config"; // portfolioStats.ts -> circuitBreaker.ts imports prisma at module scope — needs DATABASE_URL to construct, same as other DB-touching scripts
